      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.reload(true); // 'true' forces reload page in server, not in browser(load in browser may load old data from cache, not good)
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHVvbmdkaW5oIiwiYSI6ImNrN2VpaTVleTBxenYzbnBxenYxM2ZnOWYifQ.HYkRk0Wn51hw0qWB_Zqt2Q';
  var map = new mapboxgl.Map({
    container: 'map',
    // connect with element with id=map in .html
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add marker (pin)

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup infor
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"striple.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_JVWPA1yGAXFfim22BjkHbOhJ00BXP8uvnK');
...
var lgOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); // DELEGATE

if (mapBox) {
  // Get 'locations' data was pin in locations variable
...
if (lgOutBtn) {
  lgOutBtn.addEventListener('click', _login.logout);
}
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // sending 'multipart/form-data' (sending multi type of data)
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Saved password'; // Clear filled password in form
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return (0, _striple.bookTour)(tourId);
